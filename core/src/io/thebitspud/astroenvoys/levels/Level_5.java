...
public class Level_5 extends Level {
	public Level_5(AstroEnvoys app) {
		super(app);
	}
			...
			public void onActivation() {
				...
				switch (activations) {
					case 1:
						...
						game.spawnEnemy(scrWidth - 220, y + 100, EntityID.AZ_RAIDER);
					...
					case 2:
						game.spawnEnemy(r.nextInt(scrWidth / 5) + scrWidth * 2/5 - 75, y + 50, EntityID.AZ_HUNTER);
						game.spawnEnemy(r.nextInt(scrWidth / 5) + scrWidth / 5 - 60, y + 50, EntityID.AZ_RAIDER);
						game.spawnEnemy(r.nextInt(scrWidth / 5) + scrWidth * 3/5 - 60, y + 50, EntityID.AZ_RAIDER);
						...
						game.spawnEnemy(r.nextInt(scrWidth / 5) + scrWidth * 2/5 - 60, y + 200, EntityID.AZ_SNIPER);
						break;
					case 3:
						game.spawnEnemy(scrWidth / 2 - 75, y + 150, EntityID.AZ_PREDATOR);
						game.spawnEnemy(r.nextInt(scrWidth / 5) + scrWidth / 5 - 75, y + 50, EntityID.AZ_HUNTER);
						game.spawnEnemy(r.nextInt(scrWidth / 5) + scrWidth * 3/5 - 75, y + 50, EntityID.AZ_HUNTER);
						game.spawnEnemy(r.nextInt(scrWidth / 5) + scrWidth / 5 - 60, y + 100, EntityID.AZ_RAIDER);
						game.spawnEnemy(r.nextInt(scrWidth / 5) + scrWidth * 2/5 - 60, y + 100, EntityID.AZ_RAIDER);
					...
					case 4:
						...
						game.spawnEnemy(r.nextInt(scrWidth / 5) + scrWidth / 5 - 75, y + 50, EntityID.AZ_HUNTER);
						game.spawnEnemy(r.nextInt(scrWidth / 5) + scrWidth * 3/5 - 75, y + 50, EntityID.AZ_HUNTER);
						game.spawnEnemy(r.nextInt(scrWidth / 5) + scrWidth / 5 - 60, y + 200, EntityID.AZ_SNIPER);
						game.spawnEnemy(r.nextInt(scrWidth / 5) + scrWidth * 3/5 - 60, y + 200, EntityID.AZ_SNIPER);
						break;
