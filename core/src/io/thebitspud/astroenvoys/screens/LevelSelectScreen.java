...
public class LevelSelectScreen implements Screen {
	...
	public void show() {
		...
		Label title = new Label("Level Select", app.assets.titleFont);
		title.setPosition(midX - (title.getPrefWidth() / 2), midY);
		title.setAlignment(Align.center);

		JTextButton playButton = new JTextButton(midX, midY - 100, JTextButton.Size.LARGE, "Level 1", app.assets.qHorizon);
