...
public class MenuScreen implements Screen {
	...
	public void show() {
		...
		Label title = new Label("Astro Envoys", app.assets.titleFont);
		title.setPosition(midX - (title.getPrefWidth() / 2), midY);
		title.setAlignment(Align.center);

		JTextButton playButton = new JTextButton(midX, midY - 100, JTextButton.Size.LARGE, "Play", app.assets.qHorizon);
